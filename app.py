...
with st.sidebar:
    ...
    st.markdown('''
        Developed by Dhathri Bathini - 2025
        Visit my GitHub profile <a href="https://github.com/Dhathri33" style="color:white; background-color:#3187A2; padding:3px 5px; text-decoration:none; border-radius:5px;">here</a>
